...
if __name__ == "__main__":
    for key , value in company_dict.items():
        ...
        print(f'{company_full_name}の株価データを取得します。')
        main(company_name, src)
    print('日経225の株価データを取得します。')
    main('nikkei225', 'https://kabutan.jp/stock/kabuka?code=0000&ashi=day&page=')
