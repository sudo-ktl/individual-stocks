...
def get_page_links(session, url): #ページごとに変更が必要
    ...
    links_dates = []
    section_elements = response.html.find("div#posts")
    for section in section_elements:
        a_elements = section.find("div > div > a")
        p_elements = section.find("div > div > a > div.c-news__column > div > time")
...
if __name__ == "__main__":
    company_name = 'tel'
    url = "https://www.tel.co.jp/news/2023/index.html"
    ignore_strings = ['.pdf']
